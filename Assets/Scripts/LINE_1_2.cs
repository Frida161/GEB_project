...
public class LINE_1_2 : MonoBehaviour
{
    ...
    private int Last_BusStop = 5;//目前已经经过的最近站点
    ...
    private double[] simulate_GPS_x = { 114.21938f, 114.218131f, 114.217341f, 114.218024f, 114.217826f, 114.216622f, 114.209261f, 114.209234f, 114.207266f };
    private double[] simulate_GPS_y = { 22.696576f, 22.695234f, 22.693813f, 22.693034f, 22.692925f, 22.691858f, 22.692097f, 22.69631f, 22.696781f };
